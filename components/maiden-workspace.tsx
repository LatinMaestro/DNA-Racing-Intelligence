...
function projectedValue(basisPoints: number): string {
                    ...
                    <div className="flex flex-wrap items-start justify-between gap-3">
                      <div>
                        <p className="text-xs font-bold tracking-wider text-[var(--accent)] uppercase">
                          {candidate.mode} · {candidate.tournamentId}
                        </p>
                    ...
                    <dl className="mt-5 grid gap-4 text-sm sm:grid-cols-2">
                      ...
                      <div>
                        <dt className="text-[var(--muted)]">
                          Experimental projected value
                        </dt>
                        <dd className="mt-1 font-semibold">
                          {projectedValue(candidate.projectedValueBasisPoints)}
                        </dd>
                      </div>
                    </dl>
                  </li>
