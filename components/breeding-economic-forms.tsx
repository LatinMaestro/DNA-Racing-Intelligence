...
function BreedingEvidenceFields() {
  return (
    <fieldset
      aria-describedby="breeding-evidence-help"
...
function CostBasisFields() {
  return (
    <fieldset
      aria-describedby="cost-basis-help"
      className="grid gap-4"
      disabled
    >
      <legend className="text-lg font-semibold">
      ...
      <p className="text-sm leading-6 text-[var(--muted)]" id="cost-basis-help">
