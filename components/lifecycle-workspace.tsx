...
> = {
  ...
  read_model_connected: {
    ...
    detail:
      "Action order is an experimental review aid. Sale, burn and ledger mutations remain disabled.",
  },
};
    ...
    <div className="space-y-8">
      <header className="max-w-4xl">
        ...
        <p className="mt-4 text-base leading-7 text-[var(--muted)]">
          Compare race, Discovery, Maiden reserve, breed, hold, sell and burn
          evidence without erasing unresolved value. Genesis cores and no-star
          evidence alone can never produce a burn action.
        </p>
      </header>
        ...
        <div className="flex flex-wrap items-end justify-between gap-3">
          <div>
            ...
            <p className="mt-2 text-sm text-[var(--muted)]">
              ...
              {timestamp(ranking?.dataCurrentThrough ?? null)}
              {" · "}
              {ranking === null
            ...
            {ranking.cores.map((core) => (
              ...
              >
                <div className="flex flex-wrap items-start justify-between gap-3">
                  <h3 className="text-lg font-semibold">Core {core.coreId}</h3>
                ...
                {core.reviewReasons.length > 0 && (
                  <p className="mt-4 text-sm text-[var(--warning)]">
                    {core.reviewReasons.join(" ")}
                  </p>
                )}
              </li>
            ))}
