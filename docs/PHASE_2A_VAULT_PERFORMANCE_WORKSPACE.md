...
- Derive current, ageing and stale freshness from the accepted data cutoff and
  server time at every read; never trust an old persisted freshness label.
- Reject evidence whose data-current-through timestamp follows its import.
