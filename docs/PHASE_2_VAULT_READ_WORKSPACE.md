...
- loads only owner-scoped snapshot, ownership-edit, Maiden-override and known
  durable-ID evidence;
- delegates all ordering, identity, Maiden and warning behavior to the existing
  deterministic Vault registry; and
...
- owner-scoped deterministic registry projection;
- accessible semantic headings, lists and disabled controls;
