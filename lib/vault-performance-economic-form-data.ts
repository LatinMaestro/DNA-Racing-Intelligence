...
export function parseManualLedgerFormData(
  ...
  validateManualLedgerEntry(input, {
    ...
    assetRegistryVersion: configuration.assetRegistryVersion,
    serverNow: configuration.serverNow,
...
export function parseManualTournamentPayoutFormData(
  ...
  createManualTournamentPayout(input, {
    ...
    tournamentCampaignBinding: {
      ...
      evidenceId: "form-data-validation",
      configurationVersion: "form-data-validation",
      ownerAcknowledgedAt: configuration.serverNow,
    },
  });
  return input;
}
