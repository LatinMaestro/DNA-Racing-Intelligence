...
import {
  ...
  type DnaOpenLabP5SyntheticCleanupResult,
...
export function runDnaOpenLabP5PrivatePreviewCapacityMeasurement(
  ...
  return runDnaOpenLabP5CapacityMeasurement({
    ...
    runSyntheticCycle: configuration.runSyntheticCycle,
    cleanupSyntheticEvidence: configuration.cleanupSyntheticEvidence,
