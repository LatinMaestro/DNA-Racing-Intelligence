...
export const proLeagueTrialOperationsAuthority = Object.freeze({
  ...
  unresolved: Object.freeze([
    ...
    "Real-league mapped race participation is ageing-bearing, while roster membership alone is not; exact increments, thresholds, roster-lock and final administration rules remain versioned or unresolved.",
  ]),
});
