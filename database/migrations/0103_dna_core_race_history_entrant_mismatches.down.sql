...
REVOKE ALL ON FUNCTION dna.begin_dna_core_race_history_generation_v3(uuid,text,jsonb) FROM dna_app_runtime;
DROP FUNCTION dna.begin_dna_core_race_history_generation_v3(uuid,text,jsonb);
...
ALTER TABLE dna.dna_core_race_history_generation
  DROP COLUMN entrant_mismatch_omission_count;
